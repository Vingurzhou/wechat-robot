...
func newGroup(db *gorm.DB, opts ...gen.DOOption) group {
	...
	_group.Nickname = field.NewString(tableName, "nickname")
	_group.DisplayName = field.NewString(tableName, "display_name")
...
func (g *group) updateTableName(table string) *group {
	...
	g.DisplayName = field.NewString(table, "display_name")
...
func (g *group) fillFieldMap() {
	...
	g.fieldMap["display_name"] = g.DisplayName
